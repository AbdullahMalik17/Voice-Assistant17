@echo off
REM Install Google APIs Dependencies (Gmail & Drive)
REM This script installs Google Auth and API client libraries
...
python -c "import google.auth; import googleapiclient.discovery; print('✓ Google APIs installed successfully!')"
